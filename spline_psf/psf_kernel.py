...
import spline_psf.slicing as gutil
import spline_psf.generic_utils as generic_utils
import spline_psf.hardware as hardware
import spline_psf.process as process
...
class DeltaPSF(PSF):
    ...
    def __init__(self, xextent, yextent, img_shape):
        ...
        from process import RemoveOutOfFOV
        ...
        self._bin_x, self._bin_y, self._bin_ctr_x, self._bin_ctr_y = \
            generic_utils.frame_grid(img_shape, xextent, yextent)
...
class CubicSplinePSF(PSF):
    ...
    def __init__(self, xextent, yextent, img_shape, ref0, coeff, vx_size,
        ...
        self._device, self._device_ix = hardware._specific_device_by_str(device)
