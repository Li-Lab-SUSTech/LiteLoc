...
classdef calibrate_abr_map_GUI<handle
    ...
    methods
        function obj=calibrate_abr_map_GUI(varargin)  
            ...
            obj.guihandles.title=uicontrol('style','text','String','Generate PSF model for the LiteLoc network. 2024 Li lab, SUSTech','Position',[xpos1,top-vsep,xw*4.5,fieldheight],'FontSize',fontsize-2,'HorizontalAlignment',hatitle,'FontWeight','bold');
         
            obj.guihandles.filelist=uicontrol('style','listbox','String','','Position',[xpos1,top-12*vsep,xw*4,vsep*11],'FontSize',fontsize);
            ...
            obj.guihandles.selectfiles=uicontrol('style','pushbutton','String','Select camera files','Position',[xpos1,top-13*vsep,xw*4,vsep],'FontSize',fontsize,'Callback',@obj.selectfiles_callback);
            ...
            obj.guihandles.outputfile=uicontrol('style','edit','String','3dcal.mat','Position',[xpos1,top-15*vsep,xw*4,fieldheight],'FontSize',fontsize);
            obj.guihandles.outputfile.TooltipString='Name of the output file';
            
            
            obj.guihandles.selectoutputfile=uicontrol('style','pushbutton','String','Select output file','Position',[xpos1,top-16*vsep,xw*4,fieldheight],'FontSize',fontsize,'Callback',@obj.selectoutputfile_callback);
            obj.guihandles.selectoutputfile.TooltipString='Select file name for output calibration file.';    
          
            %General parameters
            ha='right';
            obj.guihandles.csplinet=uicontrol('style','text','String','General parameters for Cspline PSF model: ','Position',[xpos1+4.5*xw,top-2*vsep,xw*4,fieldheight],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');
            ...
            obj.guihandles.cutoffrelt=uicontrol('style','text','String','Relative cutoff','Position',[xpos1+7*xw,top-7*vsep,xw*1.,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.cutoffrel=uicontrol('style','edit','String','1','Position',[xpos1+8*xw,top-7*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.zernikefit=uicontrol('style','text','String','Fit zernike parameters for Vector PSF model: ','Position',[xpos1+4.5*xw,top-9*vsep,xw*4,fieldheight],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');  
            ...
            obj.guihandles.pixelSizet=uicontrol('style','text','String','Pixel sizeX','Position',[xpos1+7*xw,top-12*vsep,xw*1.,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.pixelSizeX=uicontrol('style','edit','String','110','Position',[xpos1+8*xw,top-12*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.pixelSizet=uicontrol('style','text','String','Pixel sizeY','Position',[xpos1+7*xw,top-13*vsep,xw*1.,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.pixelSizeY=uicontrol('style','edit','String','110','Position',[xpos1+8*xw,top-13*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.psfrescalet=uicontrol('style','text','String','PSF Rescale','Position',[xpos1+7*xw,top-14*vsep,xw*1,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.psfrescale=uicontrol('style','edit','String','0.5','Position',[xpos1+8*xw,top-14*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.run=uicontrol('style','pushbutton','String','Calculate the PSF model','Position',[xpos1+4.5*xw,top-16*vsep,xw*4,fieldheight],'FontSize',fontsize,'Callback',@obj.run_callback,'FontWeight','bold');
        ...
        function out=run_callback(obj,a,b)
            ...
            paraFit. psfrescale = str2num(obj.guihandles.psfrescale.String);
            paraFit.Npupil = 64;
