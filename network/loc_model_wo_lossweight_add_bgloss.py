...
from network.network import LiteLoc_add_bgchannel, LiteLoc_wo_local
    ...
    def train_spline(self):
        ...
        while self.start_epoch < self.params.Training.max_epoch:
            ...
            for i in range(0, self.params.Training.eval_iteration):
                ...
                imgs_sim, psf_imgs_gt = self.DataGen.simulate_image_liteloc_addbgloss(s_mask, xyzi_gt, locs, X, Y, Z, I)
                ...
                p, xyzi_est, xyzi_sig, psf_imgs_est = self.LiteLoc.forward(imgs_sim, test=False)
    ...
    def evaluation_spline(self):  # todo: generate three consecutive frames
        ...
        with torch.set_grad_enabled(False):
            for batch_ind, (xemit, yemit, z, S, Nphotons, s_mask, gt) in enumerate(
                ...
                P, xyzi_est, xyzi_sig, psf_imgs_est = self.LiteLoc.forward(img_sim, test=True)
