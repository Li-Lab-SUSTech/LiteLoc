...
from network.loss_utils import LossFuncs_wo_weight_add_bgloss
from utils.data_generator import DataGenerator
from network.deeploc import DeepLoc
...
class DeeplocModel:
    def __init__(self, params):
        ...
        self.DeepLoc = DeepLoc(params.Training.factor, params.Training.offset).to(torch.device('cuda'))
