...
class DECODE(torch.nn.Module):
    def __init__(self, net_pars):
        ...
        self.out_module = Outnet(self.n_filters, self.sig_pred, self.bg_pred, pad=net_pars['padding'],
                                 ker_size=net_pars['kernel_size'])
    ...
    def analyze(self, im, threshold):
        ...
        p, xyzi_est, xyzi_sig, psf_est = self.forward(im)
