...
if __name__ == '__main__':
    ...
    infer_model = torch.load(infer_params.Loc_Model.model_path) # suitable for both DECODE and LiteLoc 
    ...
    liteloc_analyzer = multi_process.CompetitiveSmlmDataAnalyzer_multi_producer(
        ...
        end_frame_num = multi_process_params.end_frame_num if 'end_frame_num' in multi_process_params else None, #
